...
public class GuiClient extends JFrame {
	...
	// Receiver and Transmitter are not needed for most planners, but may lead
	// to (negligible) speed up as you do not synchronize each
	...
	public GuiClient(String[] customs) throws IOException {
		...
		comm.add(new JScrollPane(communication, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
		...
		c.weighty = 1;
		c.fill = GridBagConstraints.BOTH;
		info.add(new JScrollPane(information, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
				JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED), c);
